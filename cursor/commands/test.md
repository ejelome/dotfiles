...
1. Resolve `<commands | rules | _functions | _mdc | _core | _roles | _settings | repo | all>` from the first token after `/test`. If missing or invalid, **ABORT** naming the token received.
