...
- **Floor rule 3 compliance:** `tools/collab/registry.py advance prev` owns registry phase, turn-order restoration, and status-table rendering. No restore-path prose-rendered write is expected; any missing mirror is a helper defect under [`_core/route-invariant.md`](../../_core/route-invariant.md) floor rule 3.
