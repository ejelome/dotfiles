...
**Slash:** `/eval uid`
**Signature:** `/eval uid <image> <project>`
**Phrases:** principal UI review, screenshot review, UID (slash preferred).
...
3. When rubric learning applies, read [shared-cmd-eval.mdc](../../_mdc/shared/shared-cmd-eval.mdc) and follow its **Protocol** and **Review workflow** after the primary review.
