...
**Slash:** `/eval igd`
**Signature:** `/eval igd <project>`
**Phrases:** game code review, Phaser review, IGD (slash preferred).
...
3. When rubric learning applies, follow [shared-cmd-eval.mdc](../../_mdc/shared/shared-cmd-eval.mdc) **Protocol** steps 2–6 after the primary review.
