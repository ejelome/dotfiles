...
**Phrases (atomic):** `atomic commits`, `split into atomic commits`, `commit by logical change`
**Phrases (squash):** `squash commits`, `squash these commits`, `combine commits`
