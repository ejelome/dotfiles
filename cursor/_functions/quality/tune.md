...
Run a named specialist evaluation command on a target, then audit cross-cutting **Criteria** and apply rubric learning via [shared-cmd-quality.mdc](../../_mdc/shared/shared-cmd-quality.mdc).
...
4. Read this file and [shared-cmd-quality.mdc](../../_mdc/shared/shared-cmd-quality.mdc). If either is not directly readable, **ABORT** per **`auto-context-gate.mdc`**.
...
10. For universal gaps, present proposed criteria and run [shared-cmd-quality.mdc](../../_mdc/shared/shared-cmd-quality.mdc) **Protocol** steps 2–6. Do not edit any playbook until the gate completes and the user confirms.
...
- **Learning:** At most 2 accepted adaptation candidates applied per run; remaining deferred to next run per [shared-cmd-quality.mdc](../../_mdc/shared/shared-cmd-quality.mdc) batch cap.
