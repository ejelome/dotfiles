...
3. When rubric learning applies, read [shared-cmd-quality.mdc](../../_mdc/shared/shared-cmd-quality.mdc) and follow its **Protocol** and **Review workflow** after the primary review.
