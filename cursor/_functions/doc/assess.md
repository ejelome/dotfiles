...
7. When rubric learning applies, follow [shared-cmd-quality.mdc](../../_mdc/shared/shared-cmd-quality.mdc) after the primary rewrite; keep candidates docs-only.
...
- **Learning:** When `shared-cmd-quality.mdc` is in scope, adaptation candidates stay documentation-only; do not promote docs findings into code-QA lanes.
