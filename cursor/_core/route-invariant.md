...
Compliance is verified by the floor-rules lint in `tools/` and covered by tests in [`_tests/_core.md`](../_tests/_core.md). A route may not be declared compliant until the lint passes against it.
