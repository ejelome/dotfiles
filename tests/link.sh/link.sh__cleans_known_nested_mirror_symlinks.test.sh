...
ln -s "$cfg/_roles" "$cfg/_roles/_roles"
...
assert_not_exists "$cfg/_roles/_roles"
assert_not_exists "$cfg/_tests/_tests"

assert_copy_matches "$home/.cursor/commands" "$cfg/commands"
assert_copy_matches "$home/.cursor/rules" "$cfg/rules"
assert_copy_matches "$home/.cursor/_functions" "$cfg/_functions"
assert_copy_matches "$home/.cursor/_core" "$cfg/_core"
assert_copy_matches "$home/.cursor/_mdc" "$cfg/_mdc"
assert_copy_matches "$home/.cursor/_roles" "$cfg/_roles"
assert_copy_matches "$home/.cursor/_tests" "$cfg/_tests"
assert_copy_matches "$home/.cursor/_CURSOR.md" "$cfg/_CURSOR.md"
