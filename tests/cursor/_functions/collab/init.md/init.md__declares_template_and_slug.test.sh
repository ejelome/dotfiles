...
grep -Fq '| 1 | mod | Moderator | Cursor Composer | facilitation; scope control; turn management; decision capture |' "$file" || fail "init.md: missing moderator participant row with count and Agent column"
