...
grep -Fq 'If the next phase is `Conclusion`, remove the moderator role from registry `turnOrder`' "$file" || fail "next.md: missing moderator removal before Conclusion"
