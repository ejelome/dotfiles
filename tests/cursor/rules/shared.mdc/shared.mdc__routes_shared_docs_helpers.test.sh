...
grep -Fq "Contract: [shared-cmd-quality](../_mdc/shared/shared-cmd-quality.mdc), [shared-cmd-values](../_mdc/shared/shared-cmd-values.mdc), [shared-docs-precedence](../_mdc/shared/shared-docs-precedence.mdc), [shared-docs-rules](../_mdc/shared/shared-docs-rules.mdc), [shared-docs-toc](../_mdc/shared/shared-docs-toc.mdc), [shared-docs-voice](../_mdc/shared/shared-docs-voice.mdc), [shared-git-commits](../_mdc/shared/shared-git-commits.mdc)" "$file" || fail "shared.mdc: missing shared docs contract"
grep -Fq "\`shared-cmd-quality.mdc\`" "$file" || fail "shared.mdc: missing shared-cmd-quality route"
