...
grep -Fq "[style-guide](../../_core/style.md)" "$file" || fail "auto-docs-markdown.mdc: missing style guide dependency"
grep -Fq "[document-standard](../../_core/document.md)" "$file" || fail "auto-docs-markdown.mdc: missing document standard dependency"
grep -Fq "[context-engineering](../../_core/context.md)" "$file" || fail "auto-docs-markdown.mdc: missing context engineering dependency"
