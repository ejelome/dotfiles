...
assert_contains "$cursor_specs" "_roles|.cursor/_roles|dir|required"
assert_contains "$cursor_specs" "_generated|.cursor/_generated|dir|required"
assert_contains "$cursor_specs" "_tests|.cursor/_tests|dir|required"
assert_contains "$cursor_specs" "_templates|.cursor/_templates|dir|required"
