...
[[ $status -ne 0 ]] || fail "check-cursor-content should reject noncanonical effort token"
assert_contains "$output" "use canonical effort token xhigh"

echo "PASS: check-cursor-content rejects noncanonical effort token"
